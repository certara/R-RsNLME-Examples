...
##                                   Run the model
##==========================================================================================================
job <- simmodel(model, simParams = SimSetup)
...
dt_CObs$id <- as.factor(dt_CObs$id5)
levels(dt_CObs$id) = c(paste0("Dose = ", dt_SimInputData$Dose[1]), paste0("Dose = ", dt_SimInputData$Dose[2]))
...
dt_A0Obs$id <- as.factor(dt_A0Obs$id5)
levels(dt_A0Obs$id) = c(paste0("Dose = ", dt_SimInputData$Dose[1]), paste0("Dose = ", dt_SimInputData$Dose[2]))
